...
async def no_cache_static(request: Request, call_next):
    ...
    p = request.url.path
    if (p.startswith("/atelier-static/") or
...
@app.get("/")
async def index():
    return FileResponse("static_atelier/login.html")


@app.get("/dashboard")
async def dashboard_page():
    return FileResponse("static_atelier/app.html")
...
async def codex_logs_page():
    return FileResponse("static_atelier/app.html")


@app.get("/page/claudecode")
async def claudecode_page():
    return FileResponse("static_atelier/app.html")


@app.get("/page/claudecode-logs")
async def claudecode_logs_page():
    return FileResponse("static_atelier/app.html")
